...
public class PokedexPokemonAdapter extends RecyclerView.Adapter<PokedexPokemonAdapter.MyViewHolder> {
    private ArrayList<Pokemon> datalist;
    private Resources resources;
    private AssetManager assetManager;


    public PokedexPokemonAdapter(ArrayList<Pokemon> datalist, Context context) {
    ...
    @NonNull
    @Override
    public PokedexPokemonAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.pokemon_layout_placeholder, parent, false);
        return new PokedexPokemonAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull PokedexPokemonAdapter.MyViewHolder holder, int position) {
        //Cargamos datos
